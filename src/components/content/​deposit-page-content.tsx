    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <Select value={selectedAsset} onValueChange={setSelectedAsset}>
          <SelectTrigger id="crypto-asset-select" aria-label="Select a crypto asset">
...
function FiatDeposit() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : "Could not submit your deposit request. Please try again.";
