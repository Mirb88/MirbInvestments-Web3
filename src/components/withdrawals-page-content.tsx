  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-2">
        ...
        <Select value={selectedAssetSymbol} onValueChange={setSelectedAssetSymbol} disabled={portfolio.holdings.length === 0}>
          <SelectTrigger>
      ...
      <Button type="submit" size="lg" className="w-full" disabled={isProcessing}>
         {isProcessing ? <LoaderCircle className="animate-spin" /> : 'Submit Crypto Withdrawal'}
      </Button>
    </form>
  );
}
...
function FiatWithdrawal() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Button type="submit" size="lg" className="w-full" disabled={isProcessing}>
        {isProcessing ? <LoaderCircle className="animate-spin" /> : 'Submit Fiat Withdrawal'}
      </Button>
    </form>
  );
}
  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-12 md:px-6">
      <header className="mb-12 text-center">
        ...
        <h1 className="mt-4 text-4xl lg:text-5xl">Withdraw Funds</h1>
