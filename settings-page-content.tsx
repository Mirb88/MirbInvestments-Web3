  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12 md:px-6">
      <header className="mb-8 text-center">
        <h1 className="text-4xl lg:text-5xl">My Account</h1>
        ...
        <CardContent className="p-6 space-y-8">
            ...
            <div className="space-y-4">
                 ...
                 <div className="rounded-lg border bg-muted p-4">
                    ...
                    <p className="text-2xl font-bold">${usdtBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <span className="text-base font-medium text-muted-foreground">USDT</span></p>
                </div>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <Button asChild size="lg">
                        <Link href={ROUTES.DEPOSIT}>
                        <ArrowDownToLine className="mr-2" /> Deposit Funds
                        </Link>
                    </Button>
                    <Button asChild variant="secondary" size="lg">
                        <Link href={ROUTES.WITHDRAWALS}>
                        <ArrowUpFromLine className="mr-2" /> Withdraw Funds
                        </Link>
                    </Button>
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="user-id" value={user.uid} readOnly />
                    <p className="text-sm text-muted-foreground">
